...
public class SecurityConfig {
	 ...
	 @Bean
	    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		 ...
		 http
      .csrf(csrf -> csrf.disable()) // só pra teste rápido (depois ativa se for web real)
      ...
      .formLogin(form -> form
    	   .loginPage("/Front/Login/login.html")
    	   .usernameParameter("email")
     	   .passwordParameter("senha")
          .loginProcessingUrl("/login")      
          .defaultSuccessUrl("/Front/Home/home.html", true)
          .failureUrl("/Front/Login/login.html?erro=Erro ao tentar entrar!!!")
          .permitAll()
      )
